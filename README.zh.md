...
### [欢迎来到 Nova 的世界 &rarr;](http://zlxy9892.github.io)


#### 1 Get Started

可通用修改 `_config.yml`文件来轻松的开始搭建自己的博客:

```
# Site settings
title: Nova Blog            # 博客网站标题
SEOTitle: Nova Blog			# 在后面会详细谈到
description: "Nova Blog"    # 随便说点，描述一下

# SNS settings      
github_username: zlxy9892       # github账号
weibo_username: jerrywinning    # 微博账号，底部链接会自动更新的。
...
# Sidebar settings
sidebar: true  #添加侧边栏
sidebar-about-description: "简单的描述一下自己"
sidebar-avatar: /img/head/head1.jpg     #个人头像，需使用绝对地址.
```
...
# Google Analytics
ga_track_id: '[]'   # 你用Google账号去注册一个就会给你一个这样的id
...
我的博客标题是 **“Nova Blog”** 但是我想要在搜索的时候显示 **“Nova的博客 | Nova Blog”** ，这个就需要SEO Title来定义了。
